# Generated by Django 2.0.7 on 2018-09-28 10:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('education', models.ManyToManyField(blank=True, null=True, to='accounts.Education')),
                ('skills', models.ManyToManyField(blank=True, to='accounts.Skills')),
                ('trainings', models.ManyToManyField(blank=True, null=True, to='accounts.Training')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
